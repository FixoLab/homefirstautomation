  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        />
        <title>Smart Home Installation in Orlando, Florida | Homefirst</title>
      </Helmet>
      <div id="site-content" className="our-process">
        <div className="our-process-hero">
          <video loop autoPlay muted>
            <source src="assets/video/our-process.mp4" type="video/mp4" />
            <source
              src="assets/video/our-process.oggtheora.ogv"
              type="video/ogg"
            />
          </video>
          ...
          <div className="our-process-hero-content">
            <div className="content-wrapper">
              ...
              <div className="content-description minigray">
                As{" "}
                <Link to="/smart-home-automation">smart home installers</Link>{" "}
                ...
                ensure you receive a high-quality, reliable solution that
        ...
        <div className="our-process-desc">
          <div className="our-process-desc-left">
            ...
            <p className="subtitle minigray">
              For all of our projects, we strive for the ultimate
              professionalism by sticking to a consistent and transparent
              process. This way you know exactly what to expect throughout all
              phases of the project and have a clear understanding of how your
              technology goals are brought to life.
            </p>
            <div className="card">
              ...
              <p className="card-description minigray">
                ...
                existing customer seeking support, we would love to hear from
                you. Don't hesitate to call or use our contact form to reach us
                for any reason. Our talented staff of representatives is
                knowledgeable, responsive and ready to answer your questions.
                Our <Link to="#">smart home company</Link> boasts technicians
                who are certified, experienced, and extremely passionate about
                every project. We take pride in building lifelong relationships
                with our valued customers. Contact us, we are ready to go to
                work for you.
              </p>
            </div>
          ...
          <div className="our-process-desc-right">
            <div className="card-item">
              ...
              <div className="card-item-desc minigray">
                Your project begins with a one-on-one conversation where we
                learn everything about your needs and preferences so we can
                design a system curated just for you. We’ll take the time to
                learn about your lifestyle, interests and budget or space
                constraints. As we learn more, we’ll be able to better tailor
            ...
            <div className="card-item">
              ...
              <div className="card-item-desc minigray">
                The next step is taking the information from the initial
                discovery meetings to craft the design for your system according
                to your performance priorities and budget qualifications. This
                proposal gives an overhead explanation of the subsystems for
                each room. It outlines the features and functionality you can
                expect from lighting, audio, video and networking. We’ll discuss
                it with you and integrate your feedback before moving on to the
                next stage.
              </div>
            </div>
            <div className="card-item">
              ...
              <div className="card-item-desc minigray">
                ...
                engineering schematics and rack elevations. By strictly
                following these plans, we ensure the final project is in line
            ...
            <div className="card-item">
              ...
              <div className="card-item-desc minigray">
                ...
                ongoing tech support. Let us craft advanced service plans for
                you that include 24/7 remote monitoring, network performance
                tests and priority response times.
              </div>
            </div>
          </div>
        </div>
