          ...
          <div className="is-layout-flow wp-block-group serviceswhitebackground">
            <div className="wp-block-group__inner-container">
              <p className="has-text-align-center">
                Architects plan everything before and manage during a residency
                or businesses creation. From deciding how the flow of a new
                property will be, to adding additions to already setup
                properties, Architects are integral to construction, and we want
                to work with you.
              </p>
            </div>
          </div>
              ...
              <div className="is-layout-flow wp-block-group servicestextcontainer eds-on-scroll eds-scroll-visible animated fadeInUp delay1 duration3">
                <div className="wp-block-group__inner-container">
                  ...
                  <p className="pointsmade homeauto">
                    ...
                    things that can improve a business or residence. Joining the
                    PROJECT: automate partner program give you access to a vast
                    database of professionals you can work with and increase
                    your revenue.
                  </p>
              ...
              <div className="is-layout-flow wp-block-group servicestextcontainer eds-on-scroll eds-scroll-visible animated fadeInUp delay1 duration3">
                <div className="wp-block-group__inner-container">
                  ...
                  <p className="pointsmade homeauto">
                    ...
                    automate offers classes on smart technologies that give you
                    a national accredited certifications. This not only allows
                    you to more easily represent your clients, but gives you an
                    extra step on top of the competition.{" "}
                  </p>
