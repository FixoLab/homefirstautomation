          ...
          <div className="is-layout-flow wp-block-group serviceswhitebackground">
            <div className="wp-block-group__inner-container">
              <p className="has-text-align-center servicesleader eds-on-scroll eds-scroll-visible animated fadeInUp duration3">
                ...
                assistance and uphold, and supporting items that are planned and
              ...
              <div className="is-layout-flow wp-block-group servicestextcontainer eds-on-scroll eds-scroll-visible animated fadeInUp delay1 duration3">
                <div className="wp-block-group__inner-container">
                  ...
                  <p className="pointsmade homeauto">
                    ...
                    and make it simpler. The Crestron Home™ application carries
                    that equivalent experience to the work environment. Go into
                    a room and easily, securely, and safely control everything –
                    while never touching anything besides your own cell phone.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="is-layout-flow wp-block-group servicestextcontainer eds-on-scroll eds-scroll-visible animated fadeInUp delay1 duration3">
                <div className="wp-block-group__inner-container">
                  ...
                  <p className="pointsmade homeauto">
                    ...
                    controllers reconsidered. They join all the best components
                    of our past with considerably further developed usefulness
                    and brilliant ergonomic design, amazing button feel, voice
                    control, custom engravable buttons, profiles settings, and
                    substantially more.
                  </p>
                </div>
              </div>
              ...
              <div className="is-layout-flow wp-block-group servicestextcontainer eds-on-scroll eds-scroll-visible animated fadeInUp delay1 duration3">
                <div className="wp-block-group__inner-container">
                  ...
                  <p className="pointsmade homeauto">
                    ...
                    separation between the workplace, design room, and home more
                    than ever. Flex MM answers the call.
                  </p>
                </div>
              </div>
            </div>
