        ...
        <div className="entry-content">
          ...
          >
            <div className="is-layout-flow wp-block-column servicesimages sidevideo">
              ...
              >
                <source
                  src="assets/video/joshai-devices.mp4"
                  type="video/mp4"
                />
              </video>
            </div>
            ...
            <div className="is-layout-flow wp-block-column servicesimages">
              ...
              >
                <div className="wp-block-group__inner-container">
                  <h2>JOSH.AI SMART HOME DEVICES</h2>

                  <p className="pointsmade homeauto">
                    With a range of smart device hubs. You can easily control
                    every smart device in your home with ease. Just plug and
                    play and start enjoying your Josh.ai system. If you need
                    something a little more customized the Johs.ai devices can
                    be easily programed to accomplish your goals.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="is-layout-flow wp-block-column servicesimages sidevideo">
              ...
              >
                <source
                  src="assets/video/joshai-security.mp4"
                  type="video/mp4"
                />
              </video>
            </div>
            ...
            <div className="is-layout-flow wp-block-column servicesimages">
              ...
              >
                <div className="wp-block-group__inner-container">
                  <h2>JOSH.AI PRIVACY</h2>

                  <p className="pointsmade homeauto">
                    Josh.ai was built with privacy in mind. They do not collect
                    your information to create a database. Instead they focus on
                    one goal. Giving the best user experience possible with the
                    upmost privacy.
                  </p>
                </div>
              </div>
          ...
          >
            <div className="is-layout-flow wp-block-column servicesimages sidevideo">
              ...
              <video
                ...
                style={{ width: "951px", height: "475.5px" }}
              >
                <source src="assets/video/joshai-eco.mp4" type="video/mp4" />
              </video>
            </div>
            ...
            <div className="is-layout-flow wp-block-column servicesimages">
              ...
              >
                <div className="wp-block-group__inner-container">
                  <h2>JOSH.AI INTEGRATION</h2>

                  <p className="pointsmade homeauto">
                    With a top of their industry staff, Josh.ai has already
                    worked to make their devices and smart systems compatible
                    with nearly every product and system out there. If its not
                    already connectable you can request Josh.ai to create
                    integration with it, or have a developer use the easy to
                    integrate API to do it themselves.
                  </p>
                </div>
              </div>
            </div>
